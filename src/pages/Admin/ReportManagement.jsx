        ...
        <AdminLayout title="Report Management">
            ...
            <div className="mt-8">
                    ...
                    <div className="space-y-8 animate-fade-in">
                        <section>
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-xl font-[600] text-[#111]">Earnings Overview</h3>
                        ...
                        <section>
                            <h3 className="text-xl font-[600] text-[#111] mb-4">Tax/VAT Reports</h3>
                ...
                {activeTab === 'operational' && (
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 animate-fade-in">
                        <section className="bg-white border border-gray-200 rounded-[30px] p-6 shadow-sm">
                            ...
                            <div>
                                <h4 className="font-[600] text-gray-500 text-[14px] mb-4">DEMAND HEATMAP (MOCK)</h4>
                        ...
                        <section className="bg-white border border-gray-200 rounded-[30px] p-6 shadow-sm">
                            <h3 className="text-xl font-[600] text-[#111] mb-8">Operational KPI Table</h3>
                ...
                {activeTab === 'user' && (
                    <div className="space-y-8 animate-fade-in">
                        <section>
                            <h3 className="text-xl font-[600] text-[#111] mb-6">Driver Leaderboard & Compliance</h3>
                            <Table headers={['Rank', 'Driver Name', 'Total Rides', 'Rating', 'Compliance Status']} headerBg="bg-[#FFF1F2]" headerAlign="text-center">
                                {[
                                    ...
                                    <tr key={i} className="border-b border-gray-100 font-[600] text-[#111] text-center">
                                        ...
                                        <td className="py-4 text-[#D10000] font-[600] tracking-wider italic">{row.rating} <i className="bi bi-star-fill text-[12px]"></i></td>
                                        <td className="py-4">
                ...
                {activeTab === 'marketing' && (
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-fade-in">
                        <section className="bg-white border border-gray-200 rounded-[30px] p-8 shadow-sm">
                            <h3 className="text-xl font-[600] text-[#111] mb-8">Promo & Ratings Analysis</h3>
                        ...
                        <section className="bg-white border border-gray-200 rounded-[30px] p-8 shadow-sm flex flex-col justify-center items-center">
                            <h3 className="text-xl font-[600] text-[#111] mb-8 self-start">Rating Distribution</h3>
                ...
                {activeTab === 'builder' && (
                    <div className="bg-white border border-gray-200 rounded-[30px] p-10 shadow-sm animate-fade-in max-w-5xl mx-auto">
                        <section className="mb-12">
                            <h3 className="text-2xl font-[600] text-[#111] mb-10 tracking-tight">Custom Report Builder</h3>
                            <div className="space-y-8 px-4">
                                ...
                                <div className="pt-8">
                                    <button className="w-full py-4 bg-[#D10000] text-white rounded-2xl font-[600] uppercase tracking-wider hover:bg-black transition-all shadow-xl shadow-red-100 italic">
                        ...
                        <section className="pt-10 border-t border-gray-100">
                            <h4 className="text-lg font-[600] text-[#111] mb-6">Recently Generated Reports</h4>
