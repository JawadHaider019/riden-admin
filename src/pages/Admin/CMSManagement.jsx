                ...
                <div className="flex bg-white border border-[#E5E7EB] rounded-full p-1 shadow-sm overflow-x-auto no-scrollbar max-w-fit">
                    {tabs.map((tab) => (
                        <button
                            ...
                            className={`px-8 py-3.5 text-[14px] font-[600] rounded-full transition-all duration-300 flex items-center gap-3 whitespace-nowrap ${activeTab === tab.id ? 'bg-[#D10000] text-white shadow-lg shadow-red-100' : 'text-gray-500 hover:text-[#111]'}`}
                        >
            ...
            <div className="animate-fade-in">
                    ...
                    <div className=" space-y-6">
                        <div className="bg-white border border-gray-200 rounded-[30px] p-6 shadow-sm">
                            ...
                            <div className="border border-gray-100 rounded-[24px]  overflow-hidden shadow-inner bg-gray-50/30">
                                <div className="bg-white p-4 border-b border-gray-100 flex items-center gap-4 flex-wrap">
                                    <div className="flex gap-1 pr-4 border-r border-gray-100">
                                        {['B', 'I', 'U'].map(btn => (
                                            <button key={btn} className="w-10 h-10 rounded-xl hover:bg-gray-50 flex items-center justify-center font-[600] text-gray-600 transition-all">{btn}</button>
                                        ))}
                                    </div>
                                    <div className="flex gap-1 pr-4 border-r border-gray-100">
                                    ...
                                    <button className="text-[13px] font-[600] text-[#D10000] ml-auto uppercase italic tracking-widest px-4">
                                ...
                                <div className="p-4 min-h-[200px] bg-white outline-none prose prose-red max-w-none text-[15px] leading-relaxed text-gray-600 font-[500]" contentEditable>
                                    <h2 className="text-[#111] font-[600]">Overview</h2>
                            ...
                            <div className=" flex justify-end gap-3 px-2">
                                <Button variant="outline" className="px-10 py-3.5 border-black text-black font-[600] rounded-2xl uppercase text-sm" onClick={() => showToast("Changes discarded", "info")}>Discard</Button>
                                <Button className="px-10 py-3.5 bg-[#D10000] text-white font-[600] rounded-2xl shadow-xl shadow-red-100 italic uppercase text-sm" onClick={() => showToast("Policy updated successfully!", "success")}>Save Changes</Button>
                            </div>
                        </div>
                    </div>
                )}
                ...
                {activeTab === 'faqs' && (
                    <div className="space-y-6 animate-fade-in">
                        <div className="flex justify-between items-center px-4">
                            <h3 className="text-xl font-[600] text-[#111]">Manage FAQ's</h3>
                        ...
                        <div className="bg-white border border-gray-200 rounded-[30px] overflow-hidden shadow-sm">
                            <table className="w-full text-center">
                                <thead className="bg-[#FFF1F2]">
                                    <tr>
                                        <th className="py-5 px-6 text-[14px] font-[600] text-[#D10000] uppercase tracking-wider">Question</th>
                                        <th className="py-5 px-6 text-[14px] font-[600] text-[#D10000] uppercase tracking-wider">Category</th>
                                        <th className="py-5 px-6 text-[14px] font-[600] text-[#D10000] uppercase tracking-wider">Status</th>
                                        <th className="py-5 px-6 text-[14px] font-[600] text-[#D10000] uppercase tracking-wider">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {faqs.map((faq) => (
                                        <tr key={faq.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                            <td className="py-5 px-6 text-[15px] font-[600] text-[#111]">{faq.question}</td>
                ...
                {activeTab === 'banners' && (
                    <div className="space-y-8 animate-fade-in">
                        <div className="flex justify-between items-center px-4">
                            <h3 className="text-xl font-[600] text-[#111]">Promotional Banners</h3>
                            ...
                            {banners.map((banner) => (
                                <div key={banner.id} className="bg-white border border-gray-200 rounded-[30px] overflow-hidden shadow-sm hover:shadow-xl transition-all group">
                                    ...
                                    <div className="p-6 flex justify-between items-center">
                                        <h4 className="font-[600] text-[#111] text-lg">{banner.title}</h4>
                ...
                {activeTab === 'about' && (
                    <div className=" space-y-6">
                        <div className="bg-white border border-gray-200 rounded-[30px] p-10 shadow-sm text-center">
                            ...
                            <h3 className="text-2xl font-[600] text-[#111] mb-2 tracking-tight">About Riden Platform</h3>
                            ...
                            <div className="space-y-6 text-left max-w-2xl mx-auto">
                                ...
                                <div className="pt-6">
                                    <Button
                                        ...
                                        className="w-full py-4 tracking-widest font-[600] uppercase italic shadow-xl shadow-red-500/10"
                                    >
