        ...
        <AdminLayout title="Reviews & Ratings">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8 bg-white border border-[#E5E7EB] rounded-[20px] mb-8 relative overflow-hidden">
                <div className="space-y-3">
                    ...
                    <h2 className="text-[42px] font-[600] text-[#111] leading-none">10.0K</h2>
                    <p className="text-[12px] font-[600] text-[#12B76A] flex items-center gap-1.5 bg-[#ECFDF3] w-fit px-3 py-1 rounded-full">
                ...
                <div className="space-y-3 md:border-l border-[#F3F4F6] md:ps-8">
                    ...
                    <div className="flex items-center gap-3">
                        <h2 className="text-[42px] font-[600] text-[#111] leading-none">4.0</h2>
                    ...
                    <div key={i} className="p-7 bg-white border border-[#E5E7EB] rounded-[20px] hover:shadow-lg hover:shadow-black/[0.03] transition-all duration-300 group">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-5">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 className="text-[16px] font-[600] text-[#111]">{r.name}</h4>
                            ...
                            <div className="flex flex-col items-end gap-2">
                                ...
                                <span className="bg-[#D10000] text-white px-4 py-1 rounded-full text-[11px] font-[600]">Booking ID {r.id}</span>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center pt-5 border-t border-[#F3F4F6]">
                            <p className="text-[13px] font-[600] text-[#9CA3AF]">
                                By {tab === 'drivers' ? 'Passenger' : 'Driver'} <span className="text-[#D10000] font-[600] cursor-pointer hover:underline underline-offset-2">{r.by.split(' ').slice(1).join(' ')}</span>
                            </p>
